...
namespace Trabalho_Interdisciplinar___Placa_de_Video
{
    public partial class QuizFacil : Form
    {
        ...
        private void QuizFacil_Load(object sender, EventArgs e)
        {
            label1.Text = "";
            label1.Hide();
            label2.Text = "";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            AcessarArquivo pergunta = new AcessarArquivo(Path.Combine(_caminho, "Facil/perguntasfaceis.txt"));
            lblPergunta.Text = pergunta.ProcurarPerguntas(x.ToString());

            AcessarArquivo alternativaA = new AcessarArquivo(Path.Combine(_caminho, "Facil/alternativasAfaceis.txt"));
            lblAlternativaA.Text = alternativaA.ProcurarPerguntas(x.ToString());

            AcessarArquivo alternativaB = new AcessarArquivo(Path.Combine(_caminho, "Facil/alternativasBfaceis.txt"));
            lblAlternativaB.Text = alternativaB.ProcurarPerguntas(x.ToString());

            AcessarArquivo alternativaC = new AcessarArquivo(Path.Combine(_caminho, "Facil/alternativasCfaceis.txt"));
            lblAlternativaC.Text = alternativaC.ProcurarPerguntas(x.ToString());

            AcessarArquivo resposta = new AcessarArquivo(Path.Combine(_caminho, "Facil/respostasfaceis.txt"));
        ...
        private void rbtnAlternativaA_CheckedChanged(object sender, EventArgs e)
        {
            

        }

        private void rbtnAlternativaB_CheckedChanged(object sender, EventArgs e)
        {
            
        }

        private void rbtnAlternativaC_CheckedChanged(object sender, EventArgs e)
        {
